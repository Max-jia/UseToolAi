  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="bg-[var(--color-card)] rounded-2xl p-6 md:p-8 border border-[var(--color-border)] space-y-6 text-[var(--color-text-muted)] leading-relaxed">
        ...
        <p>
          Every tool page carries a <strong>Last Verified</strong> date — the day we actually checked its pricing and features. When you see <span className="text-emerald-600 font-medium">✓ 2026-08-08</span>, that means someone went to the source that day. Not last year. Not "sometime."
        </p>
