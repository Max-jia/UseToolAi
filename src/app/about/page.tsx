...
export const metadata: Metadata = {
  ...
  description: "We test and compare AI tools so you don't have to. 100+ tools reviewed, 40 in-depth comparison articles. No marketing fluff. Just honest, data-driven recommendations.",
};
