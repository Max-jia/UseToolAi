...
added: "2026-07-19"
features:
  - "Paraphraser: rewrite text in 7 modes (Standard, Fluency, Formal, Creative, etc.)"
  - "Grammar Checker: catches errors with context-aware suggestions"
  - "Summarizer: condenses long articles into key points"
  - "Citation Generator: formats references in APA, MLA, Chicago"
  - "Plagiarism Checker: scans against 100M+ sources (Premium)"
pros:
  - "Best-in-class paraphrasing — 50M+ users, standard in academic and professional writing"
