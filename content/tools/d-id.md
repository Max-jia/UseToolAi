...
added: "2026-07-19"
features:
  - "Photo-to-talking-avatar: upload a still image, add text or audio, get a speaking video"
  - "AI Studio: create custom AI agents with faces, voices, and personalities for conversational video"
  - "API with real-time streaming for interactive applications (customer service, education)"
  - "ChatGPT-powered conversational avatars that can hold real-time conversations"
  - "Video editing: trim, add backgrounds, and add text overlays to generated videos"
...
cons:
  ...
  - "Deepfake concerns: the technology that powers D-ID is the same technology that powers misinformation"
coreStrength: "The technology behind 'living portraits' — turn any photo into a talking, expressive video with the most natural facial animation in the industry. B2B focused with a strong developer platform."
bestFor: "Developers building conversational AI applications, educators creating engaging video content, and brands experimenting with AI-powered customer experiences. Best for: interactive AI agents, personalized video messages, heritage preservation projects. Not for: corporate training at scale (use DeepBrain AI) or social media content (use Fliki)."
---

D-ID is the company that popularized "living portraits" — the technology that takes a still photograph and animates it into a talking, blinking, emotionally expressive video. The initial wow factor is undeniable: upload a photo of your grandmother, type a birthday message, and she appears to speak it with natural facial movement. It's the technology behind MyHeritage's viral Deep Nostalgia feature, which animated millions of historical photos in 2021, and D-ID has been refining it ever since.
